...
@media screen and (max-width: 499px) {
  .restaurant-grid,.favorit-grid {
    grid-template-columns: 1fr; /* Ubah ke satu kolom */
    gap: 16px; /* Kurangi jarak untuk layar kecil */
    padding: 16px; /* Kurangi padding untuk layar kecil */
  }
  .list_item_thumb {
